...
## [0.3.0-alpha.1] - 2026-06-27

### Fixed

- Fix pesde publishing - neither the linker file nor the library files were included
- Fix wally publishing - the linker file wasn't included
