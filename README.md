...
Rubine is available on pesde @ `marked/rubine` and Wally @ `mark-marks/rubine`.
...
Refer to [the design document](/DESIGN.md) for now, documentation will be added later™.
